...
<section class="py-5 bg-light">
    <div class="container px-4 px-lg-5 mt-5">
		...
		<c:if test="${vo.productCode ne list.productCode }">
		<c:forEach var="list" items="${productList }" begin="0" end="3">
            <div class="col mb-5">
                <div class="card h-100">
                    ...
                    <div class="card-body p-4">
                        <div class="text-center">
                            ...
                            <!-- Product price-->
                            <span class="text-muted text-decoration-line-through">${list.originPrice }원</span>
                            ${list.salePrice }원
                        </div>
                    </div>
                    <!-- Product actions-->
